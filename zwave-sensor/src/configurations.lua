...
local devices = {
  ...
  MINOSTON_DOOR_WINDOW_SENSOR_WITH_TEMPERATURE = {
    ...
    ASSOCIATION = {
      ...
      {grouping_identifier = 6}
    },
    CONFIGURATION = {
      {parameter_number = 1, configuration_value = 10, size = 1},
      {parameter_number = 2, configuration_value = 5, size = 1},
      {parameter_number = 3, configuration_value = 0, size = 1},
      {parameter_number = 4, configuration_value = 0, size = 2},
      {parameter_number = 5, configuration_value = 0, size = 2},
      {parameter_number = 6, configuration_value = 10, size = 1},
      {parameter_number = 7, configuration_value = 10, size = 1},
      {parameter_number = 8, configuration_value = 0, size = 2},
      {parameter_number = 10, configuration_value = 0, size = 2},
      {parameter_number = 12, configuration_value = 0, size = 1},
      {parameter_number = 14, configuration_value = 0, size = 1},
      {parameter_number = 16, configuration_value = 1, size = 1},
      {parameter_number = 17, configuration_value = 0, size = 1},
      {parameter_number = 18, configuration_value = 0, size = 1},
      {parameter_number = 19, configuration_value = 1, size = 1}
    }
  },
  JASCOPRO_WATER_LEAK_SENSOR = {
    ...
    CONFIGURATION = {
      {parameter_number = 3, configuration_value = 1, size = 1},
      {parameter_number = 41, configuration_value = 0, size = 1},
      {parameter_number = 84, configuration_value = 0, size = 1},
      {parameter_number = 85, configuration_value = 1, size = 1},
      {parameter_number = 86, configuration_value = 10, size = 1},
      {parameter_number = 87, configuration_value = 0, size = 1},
      {parameter_number = 88, configuration_value = 1, size = 1},
      {parameter_number = 89, configuration_value = 0, size = 1},
    },
    WAKE_UP = {
      {seconds = 43200}
    }
