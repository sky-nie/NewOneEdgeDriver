...
local devices = {
  ...
  MINOSTON_DOOR_WINDOW_SENSOR_WITH_TEMPERATURE = {
    MATCHING_MATRIX = {
      mfrs = 0x0312,
      product_types = 0x0713,
      product_ids = 0xD100
    },
    PARAMETERS = {
      batteryReportThreshold = {parameter_number = 1, size = 1},
      lowBatteryAlarmReport = {parameter_number = 2, size = 1},
      sensorModeWhenClosed = {parameter_number = 3, size = 1},
      delayReportSecondsWhenClosed = {parameter_number = 4, size = 2},
      delayReportSecondsWhenOpened = {parameter_number = 5, size = 2},
      minTemperatureOffset = {parameter_number = 6, size = 1},
      minHumidityOffset = {parameter_number = 7, size = 1},
      temperatureUpperWatermark = {parameter_number = 8, size = 2},
      temperatureLowerWatermark = {parameter_number = 10, size = 2},
      humidityUpperWatermark = {parameter_number = 12, size = 1},
      humidityLowerWatermark = {parameter_number = 14, size = 1},
      switchTemperatureUnit = {parameter_number = 16, size = 1},
      temperatureOffset = {parameter_number = 17, size = 1},
      humidityOffset = {parameter_number = 18, size = 1},
      associationGroupSetting = {parameter_number = 19, size = 1}
    }
  },
  JASCOPRO_WATER_LEAK_SENSOR = {
    MATCHING_MATRIX = {
      mfrs = 0x0063,
      product_types = 0x4953,
      product_ids = 0x3433
    },
    PARAMETERS = {
      ledMode = {parameter_number = 3, size = 1},
      ledBrightness = {parameter_number = 41, size = 1},
      resetFactoryDefault = {parameter_number = 84, size = 1},
      alarmSound = {parameter_number = 85, size = 1},
      lowBatteryReport = {parameter_number = 86, size = 1},
      lowBatteryChirp = {parameter_number = 87, size = 1},
      lowBatteryChirpInterval = {parameter_number = 88, size = 1},
      statusReporting = {parameter_number = 89, size = 1}
    }
  },
  EZMULTIPLI = {
    MATCHING_MATRIX = {
